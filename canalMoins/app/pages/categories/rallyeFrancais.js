...
@Page({
    template:
        `<ion-navbar *navbar>
    <ion-title>Rallye Francais</ion-title>
  </ion-navbar>
    ...
    <p>Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.
     Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500,
      quand un peintre anonyme assembla ensemble des morceaux de texte pour réaliser un livre spécimen de polices de texte.
       ...
       ans que son contenu n'en soit modifié.
      ...
      et empêche de se concentrer sur la mise en page elle-même. L'avantage du Lorem Ipsum sur un texte générique comme
       ...
       et en tout cas comparable avec celle du français standard. De nombreuses suites logicielles
       de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte par défaut,
      ...
      voire des phrases embarassantes).<p>
      <br>
      <br>
      <img src="images/carteRallye.png">
      <br>
      <br>
      <br>
...
<button (click)="catRallyeFr()"class="buttonNav">Scroll to the top</button>
  `
})

export class RallyeFrancais{
